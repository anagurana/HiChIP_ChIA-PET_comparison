...
for (i in 1:NROW(han_confusion_tables_chiapet_merged)){
  han_confusion_tables_chiapet_merged[i]=list(caret::confusionMatrix(factor(han_common_chiapet_manorm_merged[[names(han_confusion_tables_chiapet_merged)[i]]]$common_padj, levels=c(TRUE, FALSE)), 
