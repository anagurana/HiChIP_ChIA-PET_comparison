...
# Comparison between the technologies on the same cell line (x3) (ec. GM19238 --> ChIAPET, HiChIP and ChIPSeq)
...
common_peaks_per_cell_line=GRangesList(GRanges(), GRanges(), GRanges())
names(common_peaks_per_cell_line)=trios
...
for (cell_line in trios){
  ...
  # Draw and save the plots
  png(paste0('plots/venn_diagrams/Common_peaks_between_technologies_trial', cell_line, 
  ...
  png(paste0('plots/venn_diagrams/Common_peaks_between_trial_',experiment_1,'_and_',experiment_2,'_',cell_line,'_pulled_exp_',p_exp,'.png'), res = 300, width = 2400, height = 2400)
  plot.new()
  ...
  png(paste0('plots/venn_diagrams/Common_peaks_between_trial_',experiment_1,'_and_',experiment_3,'_',cell_line,'_pulled_exp_',p_exp,'.png'), res = 300, width = 2400, height = 2400)
  plot.new()
  draw_2_venn_diagram(NROW(peaks_raw_ChIAPET[[cell_line]]), 
                      NROW(peaks_raw_ChIPSeq[[cell_line]]), 
  ...
  png(paste0('plots/venn_diagrams/Common_peaks_between_trial_',experiment_2,'_and_',experiment_3,'_',cell_line,'_pulled_exp_',p_exp,'.png'), res = 300, width = 2400, height = 2400)
  plot.new()
