...
for (cell_line in trios){
  ...
  venndiag=VennDiagram::draw.pairwise.venn(NROW(IRanges::reduce(c(rep2_peaks_raw_ChIAPET[[paste0(cell_line,"_rep1")]], 
                                                                   rep2_peaks_raw_ChIAPET[[paste0(cell_line,"_rep2")]]))),
                                            NROW(peaks_raw_ChIAPET[[cell_line]]),
                                            NROW(subsetByOverlaps(peaks_raw_ChIAPET[[cell_line]],
                                                                  IRanges::reduce(c(rep2_peaks_raw_ChIAPET[[paste0(cell_line,"_rep1")]], 
                                                                                    rep2_peaks_raw_ChIAPET[[paste0(cell_line,"_rep2")]])))
                                                 ),
                                                scaled = T,
...
for (cell_line in trios){
  ...
  venndiag=VennDiagram::draw.pairwise.venn( NROW(IRanges::reduce(c(rep2_peaks_raw_HiChIP[[paste0(cell_line,"_rep1")]], 
                                                                   rep2_peaks_raw_HiChIP[[paste0(cell_line,"_rep2")]]))), 
                                            NROW(peaks_raw_HiChIP[[cell_line]]), 
                                            NROW(subsetByOverlaps(peaks_raw_HiChIP[[cell_line]],
                                                                  IRanges::reduce(c(rep2_peaks_raw_HiChIP[[paste0(cell_line,"_rep1")]], 
                                                                                    rep2_peaks_raw_HiChIP[[paste0(cell_line,"_rep2")]])))),
                                                scaled = T,
                                                category=c("Single replicates", "Merged replicates"),
                                                print.mode=c('raw','percent'),
