...
```{r}
manorm_find_const_peaks=function(pos_false_table, norm){
  
}

possible_common_peaks_hichip=list(
  poss_38_39=row.names(pos_false_table[[1]]$false_peaks[pos_false_table[[1]]$false_peaks$common_pval==TRUE &                                              (pos_false_table[[1]]$false_peaks[[paste0(trios[[1]],".occupancy")]]==TRUE & pos_false_table[[1]]$false_peaks[[paste0(trios[[2]],".occupancy")]]==FALSE),]),
  poss_38_40=row.names(pos_false_table[[1]]$false_peaks[pos_false_table[[1]]$false_peaks$common_pval==TRUE &                                              (pos_false_table[[1]]$false_peaks[[paste0(trios[[1]],".occupancy")]]==TRUE & pos_false_table[[1]]$false_peaks[[paste0(trios[[3]],".occupancy")]]==FALSE),]),
  poss_39_40=row.names(pos_false_table[[1]]$false_peaks[pos_false_table[[1]]$false_peaks$common_pval==TRUE &                                              (pos_false_table[[1]]$false_peaks[[paste0(trios[[2]],".occupancy")]]==TRUE & pos_false_table[[1]]$false_peaks[[paste0(trios[[3]],".occupancy")]]==FALSE),])
)

common_because_of_38=unique(
  intersect(possible_common_peaks_hichip$poss_38_39, possible_common_peaks_hichip$poss_38_40),
  intersect(possible_common_peaks_hichip$poss_38_39, row.names(pos_false_table[[4]]$false_peaks[pos_false_table[[4]]$false_peaks$common_pval==TRUE &                                              (pos_false_table[[4]]$false_peaks[[paste0(trios[[4]],".occupancy")]]==TRUE & pos_false_table[[4]]$false_peaks[[paste0(trios[[2]],".occupancy")]]==FALSE),]),),
  intersect(possible_common_peaks_hichip$poss_38_40, )
)


# Between 38 and other cell_lines
# 2571 vs 1773 --> 610 common

pos_false_table=pos_false_tables_hichip
fn_1=intersect(
  row.names(pos_false_table[[1]]$false_peaks[pos_false_table[[1]]$false_peaks$common_pval==TRUE &                                              (pos_false_table[[1]]$false_peaks[[paste0(trios[[1]],".occupancy")]]==TRUE | pos_false_table[[1]]$false_peaks[[paste0(trios[[2]],".occupancy")]]==TRUE),]),
  row.names(pos_false_table[[4]]$false_peaks[pos_false_table[[4]]$false_peaks$common_pval==TRUE &                                                (pos_false_table[[4]]$false_peaks[[paste0(trios[[1]],".occupancy")]]==TRUE | pos_false_table[[4]]$false_peaks[[paste0(trios[[3]],".occupancy")]]==TRUE),]))



# Between 39 and other cell_lines
# 2571 vs 2618 --> 968 common
fn_2=intersect(
  row.names(pos_false_table[[1]]$false_peaks[pos_false_table[[1]]$false_peaks$common_pval==TRUE &                                              (pos_false_table[[1]]$false_peaks[[paste0(trios[[1]],".occupancy")]]==TRUE | pos_false_table[[1]]$false_peaks[[paste0(trios[[2]],".occupancy")]]==TRUE),]),
  row.names(pos_false_table[[7]]$false_peaks[pos_false_table[[7]]$false_peaks$common_pval==TRUE &                                                (pos_false_table[[7]]$false_peaks[[paste0(trios[[2]],".occupancy")]]==TRUE | pos_false_table[[7]]$false_peaks[[paste0(trios[[3]],".occupancy")]]==TRUE),]))

# Between 40 and other cell_lines
# 1773 vs 7569 --> 751 common
fn_3=intersect(
  row.names(pos_false_table[[4]]$false_peaks[pos_false_table[[4]]$false_peaks$common_pval==TRUE &                                              (pos_false_table[[4]]$false_peaks[[paste0(trios[[1]],".occupancy")]]==TRUE | pos_false_table[[4]]$false_peaks[[paste0(trios[[3]],".occupancy")]]==TRUE),]),
  row.names(pos_false_table[[7]]$false_peaks[pos_false_table[[7]]$false_peaks$common_pval==TRUE &                                                (pos_false_table[[7]]$false_peaks[[paste0(trios[[2]],".occupancy")]]==TRUE | pos_false_table[[7]]$false_peaks[[paste0(trios[[3]],".occupancy")]]==TRUE),]))
...
id_constant_hichip_by_manorm_peaks=unique(c(fn_1, fn_2, fn_3))
...
constant_hichip_by_manorm_peaks.gr=GRanges(constant_hichip_by_manorm_peaks)
...
IRanges::reduce(constant_hichip_by_manorm_peaks.gr, true_common_peaks_HiChIP$constant_peaks)
